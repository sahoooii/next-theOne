// TODO:
// Make buildConversation() independent of message order.
// Current implementation assumes `messages` are sorted by created DESC.
...
export function buildConversation(
	...
	for (const message of messages) {
		...
		// Conversationの取り出し
		const conversation = conversationMap.get(otherUser.userId);
